 ...
 * @version 		$Id: process.class.php 3533 2011-11-21 14:07:21Z Bolot_Kalil $
 */
class Cars_Service_Custom_Group_Process extends Phpfox_Service
{
	/**
	 * Class constructor
	 */	
	...
	{	
		$this->_sTable = Phpfox::getT('cars_custom_group');
	}
	...
	public function delete($iId)
	{
		...
		$this->database()->update(Phpfox::getT('cars_custom_field'), array('group_id' => 0), 'group_id = ' . $aGroup['group_id']);
