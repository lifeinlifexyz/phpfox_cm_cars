 ...
 * @author  		CodeMake.Org
 * @package  		Module_Cars
 * @version 		$Id: process.class.php 3072 2011-09-12 13:23:50Z Bolot_Kalil $
 */
class Cars_Service_Category_Process extends Phpfox_Service 
{
	/**
	 * Class constructor
	 */	
	...
	{	
		$this->_sTable = Phpfox::getT('cars_category');
	}
