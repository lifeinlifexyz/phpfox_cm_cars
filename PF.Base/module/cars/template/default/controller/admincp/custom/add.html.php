 ...
 * @author  		CodeMake.Org
 * @package 		Phpfox
 * @version 		$Id: add.html.php 4731 2012-09-24 07:21:33Z Bolot_Kalil $
 */
...
<div id="js_group_holder" style="display:none;">
	{$sGroupCreateJs}
	<form method="post" action="{url link='admincp.cars.custom.add'}" id="js_group_field" onsubmit="if ({$sGroupGetJsForm}) {literal}{{/literal} $(this).ajaxCall('cars.addGroup'); {literal}}{/literal} return false;">
...
<div id="js_field_holder">
	{$sCustomCreateJs}
	<form method="post" action="{url link='admincp.cars.custom.add'}" id="js_custom_field" onsubmit="{$sCustomGetJsForm}">
	{if $bIsEdit}
